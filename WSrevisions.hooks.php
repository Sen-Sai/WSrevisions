...
class WSrevisionsHooks {
	...
	public static function getRevisionsInfo( Parser &$parser ) {
		...
		$sql = "SELECT rev_timestamp FROM " . $wgDBprefix . "revision WHERE revision WHERE rev_minor_edit='0' AND rev_page='" . $pid . "' AND (rev_timestamp < '" . $date . "' AND rev_timestamp > '" . $datum . "')";
